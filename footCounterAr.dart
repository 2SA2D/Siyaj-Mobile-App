...
class FootCounterar extends StatefulWidget {
  const FootCounterar({Key key}) : super(key: key);

  @override
  FootCounterState createState() => FootCounterState();
}

class FootCounterState extends State<FootCounterar> {
  double x = 0.0;
  double y = 0.0;
  double z = 0.0;
  int steps = 0;
